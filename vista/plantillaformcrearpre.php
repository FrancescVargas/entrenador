...
<h3> Formulario para crear preguntas </h3>
...
echo "<div id='resp'><label>Posible Respuesta</label><br></div>";
echo "<input type='button' onclick='unamas()'>Otra Posible Respuesta</button>";
...
echo "<input type='submit'>Enviar</form>";
}
